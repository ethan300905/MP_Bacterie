...
// Create a dummy CircularBoundary subclass
class Body : public CircularBoundary
{
public:
    Body(Vec2d const& position, double radius)
    : CircularBoundary(position, radius)
    {
    }

    using CircularBoundary::move;
    using CircularBoundary::setRadius;
    using CircularBoundary::setPosition;
};
