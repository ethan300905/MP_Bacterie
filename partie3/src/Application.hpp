...
public:
    ...
    enum Control { STATS, TEMPERATURE, GRADIENT, DISH_NUMBER, NB_CONTROLS=4	};
    /*!
...
//    j::Value          mJSONRead;       ///< Application configuration
    ...
    Laboratory* mLab;                       ///< Simulated environment
